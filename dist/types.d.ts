...
export declare type UseStoreReturn<S, A> = (() => [undefined, A]) & (<NS>(stateFunc: (state: S) => NS) => [NS, A]) & (<NA>(stateFunc: undefined, actionsFunc: (actions: A) => NA) => [undefined, NA]) & (<NS, NA>(stateFunc: (state: S) => NS, actionsFunc: (actions: A) => NA) => [NS, NA]);
